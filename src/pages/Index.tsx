...
import { Calendar, Clock, Users, Heart, Brain, Bone, Baby, Eye, Stethoscope, ArrowRight, Shield, Award, CheckCircle } from "lucide-react";
    ...
    <Layout>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {stats.map((stat, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="bg-card rounded-xl p-6 text-center shadow-medium border border-border"
              >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              variants={fadeUp}
              className="group bg-card border border-border rounded-xl p-8 hover:shadow-strong hover:border-primary/30 transition-all duration-300"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {departments.map((dept, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="bg-card border border-border rounded-xl p-6 hover:shadow-medium transition-all cursor-pointer group"
              >
      ...
      <section className="container py-20">
        <motion.div
          ...
          viewport={{ once: true }}
          className="gradient-primary rounded-2xl p-10 md:p-16 text-center text-primary-foreground"
        >
